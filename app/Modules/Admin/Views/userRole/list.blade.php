                        ...
                        <div class="panel panel-info @if(isset($search['submit']) && $search['submit'] == CGlobal::status_show) act @endif">
                            <form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
                                ...
                                <div class="panel-footer text-right">
                                    <a class="btn btn-default btn-sm" class="reset" href="{{route('admin.role')}}"><i class="fa fa-recycle"></i>Bỏ lọc</a>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    @foreach($data as $k=>$item)
                                        <tr>
                                            ...
                                            <td>
                                                <label class="pos-rel">
                                                    <input class="ace checkItem" name="checkItem[]" value="{{$item['role_id']}}" type="checkbox">
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            ...
                                            <td>
                                                <a class="btn btn-danger btn-sm" href="{{FuncLib::getBaseUrl()}}admin/role/edit/{{$item['role_id']}}">Sửa</a>
                                                <a class="btn btn-danger btn-sm" href="{{FuncLib::getBaseUrl()}}admin/role/permission/{{$item['role_id']}}">Phân quyền</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
