...
@section('content')
                                            ...
                                            <div class="tab-pane panelDetail active" id="tabNoiDung" role="tabpanel">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="photo_title" value="@if(isset($data['photo_title'])){{$data['photo_title']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <input name="image_primary" type="hidden" id="image_primary"  value="@if(isset($data['photo_image'])){{trim($data['photo_image'])}}@endif">
                                                                </div>
                                                                <!--Hien Thi Anh-->
                                                                        ...
                                                                        @foreach($news_image_other as $k=>$v)
                                                                            <li id="sys_div_img_other_{{$k}}">
                                                                                <div class="div_img_upload">
                                                                                    ...
                                                                                    <br/>
                                                                                    <a href="javascript:void(0);" id="sys_delete_img_other_{{$k}}" onclick="UploadAdmin.removeImage('{{$k}}', '{{$data['photo_id']}}', '{{$v['img_other']}}', '6');">Xóa ảnh</a>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="photo_content">@if(isset($data['photo_content'])){{stripslashes($data['photo_content'])}}@endif</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select class="form-control input-sm" name="photo_focus">
                                                                {!! $optionFocus !!}}
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select class="form-control input-sm" name="photo_status">
                                                                {!! $optionStatus !!}}
                                                            </select>
                                                        </div>
                                                    </div>
    ...
    <script>
        CKEDITOR.replace('photo_content');
        //Keo Tha Anh
        ...
        function insertImgContent(src){
            CKEDITOR.instances.photo_content.insertHtml('<img src="'+src+'"/>');
        }
        insertExtLinkContent();
        function insertExtLinkContent(){
            $('.extLinkClick ul li').click(function(){
                var text = $(this).html();
                CKEDITOR.instances.photo_content.insertHtml(text);
            });
        }
    </script>
@stop
