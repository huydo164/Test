...
@section('content')
                                            ...
                                            <div class="tab-pane panelDetail active" id="tabNoiDung" role="tabpanel">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="demo_title" value="@if(isset($data['demo_title'])){{$data['demo_title']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <a href="javascript:;"class="btn btn-primary link-button btn-sm" onclick="UploadAdmin.uploadMultipleImages(9);">Upload ảnh</a>
                                                                    <input name="image_primary" type="hidden" id="image_primary"  value="@if(isset($data['demo_image'])){{trim($data['demo_image'])}}@endif">
                                                                </div>
                                                                <!--Hien Thi Anh-->
                                                                        ...
                                                                        @foreach($news_image_other as $k=>$v)
                                                                            <li id="sys_div_img_other_{{$k}}">
                                                                                <div class="div_img_upload">
                                                                                    ...
                                                                                    <br/>
                                                                                    <a href="javascript:void(0);" id="sys_delete_img_other_{{$k}}" onclick="UploadAdmin.removeImage('{{$k}}', '{{$data['demo_id']}}', '{{$v['img_other']}}', '9');">Xóa ảnh</a>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <button type="button" onclick="UploadAdmin.getInsertImageContent(9, 'open')" class="btn btn-primary btn-sm">Chèn ảnh vào nội dung</button>
                                                        </div>
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="demo_content">@if(isset($data['demo_content'])){{stripslashes($data['demo_content'])}}@endif</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select class="form-control input-sm" name="demo_focus">
                                                                {!! $optionFocus !!}}
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select class="form-control input-sm" name="demo_status">
                                                                {!! $optionStatus !!}}
                                                            </select>
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        function insertImgContent(src){
            CKEDITOR.instances.demo_content.insertHtml('<img src="'+src+'"/>');
        }
        insertExtLinkContent();
        function insertExtLinkContent(){
            $('.extLinkClick ul li').click(function(){
                var text = $(this).html();
                CKEDITOR.instances.demo_content.insertHtml(text);
            });
        }
    </script>
@stop
